...
export function SearchField({ value, onChangeText }: ISearchFieldProps) {
	return (
		<View className='flex-row items-center gap-3 rounded-xl border border-gray-200 bg-white px-4'>
			<SearchIcon color={COLORS.gray[400]} size={18} strokeWidth={1.8} />

			<TextInput
				autoCapitalize='none'
				autoCorrect={false}
				className='h-12 flex-1 font-inter-regular text-body-md text-gray-900'
